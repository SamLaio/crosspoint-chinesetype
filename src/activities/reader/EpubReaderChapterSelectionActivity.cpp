...
void EpubReaderChapterSelectionActivity::renderScreen() {
  ...
  const int titleX =
      contentX + (contentWidth - renderer.getTextWidth(UI_12_FONT_ID, getChineseName("Table of contents"), EpdFontFamily::BOLD)) / 2;
  renderer.drawText(UI_12_FONT_ID, titleX, 15 + contentY, getChineseName("Table of contents"), true, EpdFontFamily::BOLD);
