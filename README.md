...
| Build | Version |
| --- | --- |
| 開發版 `default` | `zhTW_V2.5.5-allocate` |
| Release `gh_release` | `zhTW_V2.5.5` |
| RC `gh_release_rc` | `zhTW_V2.5.5-rc+<hash>` |
| Slim `slim` | `zhTW_V2.5.5-slim` |

目前尚未針對 `zhTW_V2.5.5` 重新編譯。工作目錄內既有 `default` 產物為：
