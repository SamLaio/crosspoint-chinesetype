...
晚点我会发个视频详细介绍功能，避免重复工作

多多少少的贡献都可以哈，有编程能力的都可以玩一下，不用加我联系方式，去掉无用社交，咱们就是开放式玩起来。
...
开源库部分需要复制我版本信息里感谢的这些库，并将我列为参考改版项目。感谢理解。

# 闭源维护

卷土重来，从内耗型人格改为外耗型

等我周末放代码，连同一个静态网站的demo会放在主页另一个库吧，到时候新建一个，收集我的一些弃案，期待焕发新的生机，当然，这部分肯定不是AGPL开源协议hhh，会更开放一点，但是同样禁商业化吧
