...
# \*\*如发现本项目以及本项目涉及到的衍生版本，被用于任何商业行为、商用产品、付费服务或售卖，本人将立即追究其全部法律责任。\*\*
...
# \- 键盘QR输入:\[QR\_input](https://github.com/crosspoint-reader/crosspoint-reader/pull/839)
...
# 如果后续改版我的项目需要 @allocated 我并说明，不然不要怪我说话难听了。
