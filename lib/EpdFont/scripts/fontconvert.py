...
intervals = [
    ...
    (0x31F0, 0x31FF),
    # Halfwidth Katakana (半角片假名)
    (0xFF60, 0xFF9F),
    # Hangul Syllables (韩文音节)
    (0xAC00, 0xD7AF),
    # Hangul Jamo (韩文字母)
    (0x1100, 0x11FF),
    # Hangul Compatibility Jamo (韩文兼容字母)
    (0x3130, 0x318F),
    # Hangul Jamo Extended-A (韩文字母扩展A)
    (0xA960, 0xA97F),
    # Hangul Jamo Extended-B (韩文字母扩展B)
    (0xD7B0, 0xD7FF),
    ...
    (0xF900, 0xFAFF),
    ### Specials ###
    # Replacement Character (替换字符，用于无法显示的字符)
    (0xFFFD, 0xFFFD),
]
...
""")
    ...
    print ("};\n");
    # Bitmaps already printed above in the else block start
